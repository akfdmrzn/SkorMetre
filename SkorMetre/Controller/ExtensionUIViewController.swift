...
extension UIViewController {
    ...
    func sosPresentViewController(viewController: UIViewController, animated: Bool = true, completion: (() -> Void)? = nil) {
        self.present(viewController, animated: animated, completion: completion)
    }
    
    func sosPushViewController(viewController: UIViewController, animated: Bool = true) {
        self.navigationController?.pushViewController(viewController, animated: animated)
    }
    
    func sosPresentViewController(type: MainStoryBoardViewController, animated: Bool = true, completion: (() -> Void)? = nil) {
        let storyBoard:UIStoryboard = UIStoryboard(name: "Main", bundle: nil)
        let viewController = storyBoard.instantiateViewController(withIdentifier: type.rawValue)
        sosPresentViewController(viewController: viewController, animated: animated, completion: completion)
    }
    
    func sosPushViewController(type: MainStoryBoardViewController, animated: Bool = true) {
        let storyBoard:UIStoryboard = UIStoryboard(name: "Main", bundle: nil)
        let viewController = storyBoard.instantiateViewController(withIdentifier: type.rawValue)
        self.sosPushViewController(viewController: viewController, animated: animated)
    }
    
    func sosReturnViewController(type: MainStoryBoardViewController, animated: Bool = true)-> UIViewController {
        let storyBoard:UIStoryboard = UIStoryboard(name: "Main", bundle: nil)
        let viewController = storyBoard.instantiateViewController(withIdentifier: type.rawValue)
